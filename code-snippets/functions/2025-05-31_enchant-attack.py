def enchant_and_attack(target_health, damage, weapon):
    enchanted_damage = damage + 10 # New enchanted damage variable
    new_health = target_health - enchanted_damage # New health variable 
    enchanted_weapon = f"enchanted {weapon}" # New variable using f string
